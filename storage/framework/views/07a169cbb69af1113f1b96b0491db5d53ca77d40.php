        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form action="<?php echo e(route('register')); ?>" method="POST">
              ...
              <div>
                <input type="text"  class="form-control form-control <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> form-control-lg " value="<?php echo e(old('name')); ?>" placeholder="Username" required="" />
...
unset($__errorArgs, $__bag); ?> form-control-lg" value="<?php echo e(old('email')); ?>" placeholder="Email" required="" />
                <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\laragon\www\TriCoba\resources\views/auth/login.blade.php ENDPATH**/ ?>