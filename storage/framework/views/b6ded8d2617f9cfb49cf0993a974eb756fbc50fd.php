...
<form action="<?php echo e(route('GJpenerimaankain.store')); ?>" method="POST" data-parsley-validate>
 <?php echo csrf_field(); ?>
 <div class="modal-body">
  <label>Kode Barang: </label>
   <div class="form-group">
    <input type="text" class="form-control" name="kode_barang" value="<?php echo e(bin2hex(random_bytes(3))); ?>" readonly>
  </div>
  <label>Tanggal: </label>
   <div class="form-group">
     <input
...
</div><?php /**PATH C:\laragon\www\TriCoba\resources\views/GJpenerimaankain/create.blade.php ENDPATH**/ ?>