...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        $(function () {
          var table = $('.data-table').DataTable({
              processing: true,
              serverSide: true,
              ajax: "<?php echo e(route('customerkain.index')); ?>",
              columns: [
                  {data: 'id', name: 'id'},
  ...
  >
   ...
   <form action="<?php echo e(route('customerkain.store')); ?>" method="POST" data-parsley-validate>
       <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.mazer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TriCoba\resources\views/customerkain/index.blade.php ENDPATH**/ ?>