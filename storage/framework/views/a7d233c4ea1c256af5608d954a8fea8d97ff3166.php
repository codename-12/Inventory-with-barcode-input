        ...
        <script type="text/javascript">
            $(function () {
              var table = $('.data-table').DataTable({
                  ...
                  serverSide: true,
                  scrollX: true,
                  ajax: "<?php echo e(route('GJstockpolos.index')); ?>",
                  columns: [
                      {data: 'id', name: 'id'},
...
<?php echo $__env->make('layouts.mazer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TriCoba\resources\views/GJstockpolos/index.blade.php ENDPATH**/ ?>