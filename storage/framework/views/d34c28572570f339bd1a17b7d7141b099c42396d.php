<div id="sidebar" class="active">
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li>
                <a href="<?php echo e(route('masterbenang.index')); ?>" class="sidebar-link">
                  <i class="bi bi-boxes"></i>
                  <span>Stok Benang</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('benang.index')); ?>" class="sidebar-link">
                  <i class="bi bi-box-arrow-in-down"></i>
                  <span>Penerimaan Benang</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('obenang.index')); ?>" class="sidebar-link">
                  <i class="bi bi-box-arrow-up"></i>
                  <span>Pengeluaran Benang</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('supbenang.index')); ?>" class="sidebar-link">
                  <i class="bi bi-truck"></i>
                  <span>Supplier benang</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('BPBbenang.index')); ?>" class="sidebar-link">
                  <i class="bi bi-receipt"></i>
                  <span>Bukti Penerimaan Benang</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('invoicebenang.index')); ?>" class="sidebar-link">
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li>
                <a href="<?php echo e(route('customerkain.index')); ?>" class="sidebar-link">
                  <i class="bi bi-dropbox"></i>
                  <span>Customer</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('KOP.index')); ?>" class="sidebar-link">
                  <i class="bi bi-dropbox"></i>
                  <span>Kartu Order Proses</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('KOPP.index')); ?>" class="sidebar-link">
                  <i class="bi bi-dropbox"></i>
           ...
           <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li>
                <a href="<?php echo e(route('GJpenerimaankain.index')); ?>" class="sidebar-link">
                  <i class="bi bi-dropbox"></i>
                  <span>Penerimaan kain</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('GJpengirimankain.index')); ?>" class="sidebar-link">
              ...
              <li>
                <a href="<?php echo e(route('GJhstockpolos.index')); ?>" class="sidebar-link">
                  <i class="bi bi-layers"></i>
                  <span>PENGIRIMAN STOCK POLOS</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('GJhstockprinting.index')); ?>" class="sidebar-link">
                  <i class="bi bi-layers-fill"></i>
                  <span>PENGIRIMAN STOCK PRINTING</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('GJhbspolos.index')); ?>" class="sidebar-link">
                  <i class="bi bi-trash3"></i>
                  <span>PENGIRIMAN BS POLOS</span></a>
              </li>
              <li>
                <a href="<?php echo e(route('GJhbsprinting.index')); ?>" class="sidebar-link">
                  <i class="bi bi-trash3-fill"></i>
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li>
                <a href="<?php echo e(route('rajut.index')); ?>" class="sidebar-link">
                  <i class="bi bi-boxes"></i>
  ...
  </div><?php /**PATH C:\laragon\www\TriCoba\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>